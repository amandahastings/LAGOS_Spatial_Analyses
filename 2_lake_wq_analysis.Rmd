...
There is a negative correlation between secchi disk depth and chlorophyll a levels, where higher chlorophyll a levels are associated with shallower secchi disk depths. 


## Why might this be the case? 

High cholorphyll a concentrations are associated with high biomass of photosynthetic organisms, such as algae. Meanwhile, secchi disks are used to assess water turbidity, where the depth of disk disappearance indicates the transparency of the water(). 
...
spatial_counts <- st_as_sf(stateid_counts,coords=c('nhd_long','nhd_lat'),
                          crs=4326)

# states_join <- inner_join(spatial_counts,stateid_counts,by='state_name')


mapview(spatial_counts)

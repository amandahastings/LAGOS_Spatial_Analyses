...
*The Global Surface Water Dataset, derived from LANDSAT imagery and hosted by the Joint Research Centre (JRC),  Subsetted data from this dataset are availabile via Google Earth Engine (Meyer et al. 2020).
